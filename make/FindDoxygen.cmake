...
IF (NOT DOXYGEN_FIND_QUIETLY)
  IF (DOXYGEN_DOT_EXECUTABLE)
    ...
    SET(DOXYGEN_DOT_PACKAGE graphviz CACHE STRING "The rpm package name containing dot tool")
...
IF (DOXYGEN_PACKAGE AND DOXYGEN_DOT_PACKAGE)
   SET(MAKE_APIDOC 1 CACHE STRING "make_apidoc")
ELSE (DOXYGEN_PACKAGE AND DOXYGEN_DOT_PACKAGE)
   SET(MAKE_APIDOC 0 CACHE STRING "make_apidoc")
