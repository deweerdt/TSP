...
#line 2 "tsp_ascii_writer_config.y"
...
/* Line 214 of yacc.c.  */
#line 111 "tsp_ascii_writer_config.tab.c"
...
{
  "$end", "error", "$undefined", "T_SAMPLE_SYMBOL", "T_PERIOD", "T_SPACE", 
  "T_NEWLINE", "T_COMMENT", "$accept", "INPUT", "LINE", "SAMPLE_LINE", 
  "COMMENT_LINE", "VOID_LINE", 0
};
#endif
...
#line 15 "tsp_ascii_writer_config.y"
