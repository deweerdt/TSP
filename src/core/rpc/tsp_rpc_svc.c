...
/* Suppression car ne fonctionne pas mais ne sert pas non plus ! */
...
/* AP : Migration sous Windows */
/* ne trouve pas le fichier "rpc/tsp_rpc.h" */
#include "tsp_rpc.h"
...
{
	return (tsp_request_filtered_information_1_svc(argp->req_info, argp->filter_kind, argp->filter_string, rqstp));
}
