...
# /home/eric/Syntegra/TSPOpen/Savannah/vues/Erk/tsp will be set by the configure script 
export TSP_BASE=/home/eric/Syntegra/TSPOpen/Savannah/vues/Erk/tsp
...
export PATH=${TSP_BASE}/src/scripts:${HOME_EXEC_CURRENT}/bin.consumer.debug:${HOME_EXEC_CURRENT}/bin.provider.debug:${TSP_BASE}/src/tsp/tests/stage1:${TSP_BASE}/src/tsp/tests/stage2:${TSP_BASE}/src/tsp/tests/stage3:${PATH}
