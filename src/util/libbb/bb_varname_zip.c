...
$Header: /home/def/zae/tsp/tsp/src/util/libbb/bb_varname_zip.c,v 1.1 2007-02-22 14:54:54 deweerdt Exp $
...
int32_t bb_set_varname_zip(S_BB_DATADESC_T *dd, const char *key)
{
	int ret;
  unsigned long len;
  char *comp;
