...
void gtk_plot_pc_clip_mask                              (GtkPlotPC *pc,
							 ...
							 gdouble y,
                                                         GdkBitmap *mask)
{
  GTK_PLOT_PC_CLASS(GTK_OBJECT(pc)->klass)->clip_mask(pc, x, y, mask);
}
...
void gtk_plot_pc_set_font                                (GtkPlotPC *pc,
							 GtkPSFont *psfont,
                                                         gint height)
{
  GTK_PLOT_PC_CLASS(GTK_OBJECT(pc)->klass)->set_font(pc, psfont, height);
}
...
{
  GTK_PLOT_PC_CLASS(GTK_OBJECT(pc)->klass)->draw_pixmap(pc,
                                                        pixmap,
                                                        mask,
                                                        xsrc, ysrc,
                                                        xdest, ydest,
